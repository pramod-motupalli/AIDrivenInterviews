      ...
      <main className="wr-main">
        <div className="wr-container">
          ...
          <div className="wr-info-stack">
            ...
            <div className="wr-card">
              <div className="wr-role-name">Senior Product Designer</div>
              <div className="wr-role-dept">Lead Experience Team</div>
              <div className="wr-role-meta">ID: IV-882-991 • 90 Minutes</div>
            </div>

            <div className="wr-card">
              <div className="wr-int-row">
                <div className="wr-avatar">SJ</div>
                <div>
                  <div className="wr-int-name">Sarah Jones</div>
                  <div className="wr-int-role">Senior Lead, Design Operations</div>
                </div>
              </div>
            </div>
