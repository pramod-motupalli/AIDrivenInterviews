...
const Header = ({ title }) => {
  ...
  return (
    <header className="sticky top-0 z-40 flex justify-between items-center pt-safe px-4 py-3 md:px-10 md:py-6 bg-white/80 backdrop-blur-xl border-b border-slate-100 shadow-sm">
      ...
      <div className="flex items-center gap-3 md:gap-4">
        ...
        <img 
          ...
          alt="User Avatar" 
          className="w-8 h-8 md:w-10 md:h-10 rounded-xl md:rounded-2xl object-cover border-2 border-white shadow-md"
        />
      </div>
    </header>
  );
