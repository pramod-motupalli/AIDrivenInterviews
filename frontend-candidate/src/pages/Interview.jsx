...
const ActiveInterview = () => {
  ...
  useEffect(() => {
    if (currentIndex > 0 && questions && questions[currentIndex - 1]) {
      ...
      const lastAnswer = answers[currentIndex - 1] || "No response recorded.";
      ...
      setHistory(prev => {
        ...
        return [
          ...prev,
          {
            type: 'ai',
            question: lastQ.text,
            category: lastQ.category || 'TECHNICAL EXPERIENCE'
          },
          {
            type: 'candidate',
            response: lastAnswer
  ...
  const handleNext = async () => {
    ...
    try {
      if (currentQuestion) {
        await submitAnswer(null, transcript);
      }
      setTranscript('');
      nextQuestion();
    } catch (err) {
  ...
  const progressPercent = useMemo(() => {
    ...
    const limit = 5; // The backend caps the interview at 5 questions
    return Math.round(((currentIndex + 1) / limit) * 100);
  }, [currentIndex, questions]);

  // Handle initial missing data state gracefully
    ...
    <div className="interview-page">
      ...
      <nav className="nav-bar">
        ...
        <div className="nav-center">
          <span className="progress-label">Question {currentIndex + 1} of 5</span>
          ...
          <div className="block-row">
            <div className="flex flex-col items-center gap-3">
              ...
              <div className="flex flex-col items-center">
                <span className="candidate-name text-xs">{candidateName}</span>
